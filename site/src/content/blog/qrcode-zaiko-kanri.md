...
「在庫管理にQRコードを使いたいけど、バーコードと何が違うの？」「ラベルを貼って読み取るだけで、本当に在庫が合うようになる？」——在庫管理の改善を調べ始めると、必ずQRコードにたどり着きます。
...
| 読み取り | 専用リーダーが得意（スマホも可） | **スマホのカメラで読みやすい** |
...
A. 必須ではありません。お手持ちのスマホやタブレットのカメラで読み取る形にすれば、機器の追加投資をほぼゼロにできます。読み取り頻度が非常に多い現場だけ、専用機を検討すれば十分です。
