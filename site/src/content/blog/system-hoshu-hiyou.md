...
<ul>
<li>一般的な相場「開発費の10〜15%／年」は、大規模システム前提の数字</li>
<li>中小企業の小さな業務システムなら、月1万円〜の保守で現実的に運用できる</li>
<li>ビズシスの保守は月1万円〜（サーバー実費・バックアップ・不具合対応・軽微な調整を含む）</li>
</ul>
</div>
...
ここを混ぜて「保守の範囲内で何でもやってもらえる」と期待すると、後でもめる原因になります。**保守は現状維持＋小さな調整まで、機能追加は都度見積**です。
