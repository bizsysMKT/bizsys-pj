...
結論から言うと、業務システムの保守費用の一般的な相場は「開発費の10〜15%／年」ですが、これは大規模システム前提の数字です。中小企業の小さな業務システムなら、月1万円〜の保守で現実的に運用できます。ビズシスの保守費用は月1万円〜で、サーバー等の実費・バックアップ・不具合対応・軽微な調整までを含みます。
